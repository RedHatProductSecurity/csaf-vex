...
vex = CSAFVEXBuilder.build(
    ...
    product_tree_data={
        "name": "Red Hat",
        "components": [
            {"name": "component1", "purl": "pkg:rpm/redhat/component1@1.0"}
        ],
        "streams": [
            {"name": "stream1", "cpe": "cpe:/o:redhat:enterprise_linux:8"}
        ],
        "products": [
            {
                "name": "Product 1",
                ...
                "stream": "stream1",
                "purl": "pkg:rpm/redhat/component1@1.0",
            }
        ],
    },
)
...
document_data = {
    "publisher": {
        ...
        "namespace": "https://redhat.com",
        "contact_details": "https://access.redhat.com/security/team/contact/",
        "issuing_authority": "Red Hat Product Security is responsible for vulnerability handling.",
    },
...
vulnerability_data = {
    ...
    "product_status": {
        "known_affected": ["rhel-8:openssl", "rhel-9:openssl"],
    },
    "score": {
    ...
    "references": [
        {
            ...
            "summary": "CVE-2025-12345 on Red Hat Customer Portal",
        },
        {
            "category": "external",
...
product_tree_data = {
    "name": "Red Hat",
    "components": [
        {"name": "openssl", "purl": "pkg:rpm/redhat/openssl@3.0.7"},
    ],
    "streams": [
        {"name": "rhel-8", "cpe": "cpe:/o:redhat:enterprise_linux:8"},
        {"name": "rhel-9", "cpe": "cpe:/o:redhat:enterprise_linux:9"},
    ],
    "products": [
        {
            ...
            "component": "openssl",
            "stream": "rhel-8",
            "purl": "pkg:rpm/redhat/openssl@3.0.7",
        },
        {
